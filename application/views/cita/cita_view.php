<div class="row">
	<div class="col-lg-12">
		<h2 class="page-header">Cita<small><i class="glyphicon glyphicon-chevron-right"></i> calendario de citas</small></h2>
	</div>
</div>
<div class="row content-calendar">
	<div class="col-lg-3" style="padding-right:0px">
		...
		<div>
			<a href="/calendario-citas" style="color:#333">Ver todas las citas</a>
		</div>
		<div class="input-group">
			<input placeholder="busque su cita por..." type="text" class="form-control" name="txtBusqueda" style="float:none;border-bottom-left-radius:4px;border-top-left-radius:4px">
