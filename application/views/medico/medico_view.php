<div class="row">
	<div class="col-lg-12">
		<h2 class="page-header">Médico<small><i class="glyphicon glyphicon-chevron-right"></i> agregar médico</small></h2>
	</div>
</div>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default padre-popover">
			...
			<form role="form" id="frm-medico" action="/guardar-medico" method="POST">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group input-group-sm">
								...
								<input type="hidden" name="hdndepartamentoid" value="<?=@$medico->departamentoid?>">
								<input type="hidden" name="hdnprovinciaid" value="<?=@$medico->provinciaid?>">
								<input type="hidden" name="hdndistritoid" value="<?=@$medico->distritoid?>">
