	...
	<div class="col-md-12">
		<div class="modal" id="modalSubirInforme" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<form method="POST" action="/subir-informe" enctype="multipart/form-data">
						...
						<tbody>
							<?php foreach($informes as $informe):?>
								<tr>
									...
									<td><center><a href="/paciente/informe/download/<?=@$informe->nombre.@$informe->tipo.'/'.@$informe->historiaclinicaid?>"><i class="glyphicon glyphicon-download-alt"></i></a></center></td>
