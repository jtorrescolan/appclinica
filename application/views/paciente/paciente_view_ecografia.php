<div class="modal" id="modalSubirImagen" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<form id="frm-subir-eco" method="POST" action="/subir-ecografia" enctype="multipart/form-data">
		...
		<?php foreach ($ecografias->result() as $ecografia):?>
			<div class="col-md-3" style="margin-bottom:12px;">
				...
				<div class="caption">
					...
					<p><?=@$ecografia->fecha?></p>
					<p>
						<a href="/ecografia/ecografia/download/<?=$ecografia->nombre.$ecografia->tipo.'/'.$ecografia->historiaclinicaid?>" class="btn btn-primary" role="button"><i class="glyphicon glyphicon-download-alt"></i></a>
