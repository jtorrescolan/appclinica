...
if ( ! defined('BASEPATH')) exit('No direct script access allowed');    
    class Login extends CI_Controller {
        ...
        function log_in(){
            ...
            $check_user = $this->login_model->login_user($usuario);
            $check_user_pass=FALSE;

            if($usuario==$check_user->usuario&&$contrasenia==$this->encrypt->decode($check_user->contrasenia)){
            ...
            if($check_user_pass==TRUE){
				...
				redirect(base_url().'iniciar-sesion','refresh');
            }
        }
