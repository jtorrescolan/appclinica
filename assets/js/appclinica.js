$(document).on('ready',function(){
	...
	function initTableUsuario(){
		return $('#tbl-lista-usuario').dataTable({
			'bRetrieve':true
		});
	}
	...
	$('#informe').on('click','button[name="btnHecho"]',function(){
		$('#informe').load('/paciente/paciente/getListaInforme/'+$('#frm-Anamnesis input[name="hdnhistoriaclinicaid"]').val(),function(){
			cargarBotonCancelarInforme();
			cargarAjaxLoader();
			cargarBotonInforme();
			cargarSubidaInforme();
	...
	$('#ecografia').on('click','button[name="btnHecho"]',function(){
		$('#ecografia').load('/ecografia/ecografia/getEcografia/'+$('#frm-Anamnesis input[name="hdnhistoriaclinicaid"]').val(),function(){
			cargarBotonCancelarEcografia();
			cargarAjaxLoader();
			cargarBotonEcografia();
			cargarSubidaEcografia();
	...
	$('#rayosx').on('click','button[name="btnHecho"]',function(){
		$('#rayosx').load('/rayosx/rayosx/getRayosx/'+$('#frm-Anamnesis input[name="hdnhistoriaclinicaid"]').val(),function(){
			cargarBotonCancelarRayosX();
			cargarAjaxLoader();
			cargarBotonRayosX();
			cargarSubidaRayosX();
	...
	$('#diagnostico').on('click','button[name="btn-agregar-enfermedad"]',function(){
		$('#diagnostico').load('/paciente/paciente/getEnfermedad/'+$('#frm-Anamnesis input[name="hdnhistoriaclinicaid"]').val(),function(){
	...
	$('#diagnostico').on('click','button[name="btn-atras-enfermedad"]',function(){
		$('#diagnostico').load('/paciente/paciente/getListaEnfermedad/'+$('#frm-Anamnesis input[name="hdnhistoriaclinicaid"]').val(),function(){
			initTableDiag();
			$('div[class="dataTables_length"] label select, div[class="dataTables_filter"] label input').addClass('form-control');
			$('div[class="dataTables_length"] label select, div[class="dataTables_filter"] label input').addClass('input-sm');
		});
	...
	$('#diagnostico').on('click','a[name="editar-enfermedad"]',function(){
		$('#diagnostico').load('/editar-enfermedad/'+$(this).attr('value'),function(){
			$('#form-agregar-enfermedad').validate({
				rules:{
